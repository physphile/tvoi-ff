...
export const getAllGroupsGroupGet = <ThrowOnError extends boolean = false>(
	...
	return (options?.client ?? _heyApiClient).get<GetAllGroupsGroupGetResponse, GetAllGroupsGroupGetError, ThrowOnError>({
		security: [
			{
				name: "Authorization",
				type: "apiKey",
...
export const createGroupRequestGroupPost = <ThrowOnError extends boolean = false>(
	...
	return (options?.client ?? _heyApiClient).post<CreateGroupRequestGroupPostResponse, unknown, ThrowOnError>({
		security: [
			{
				name: "Authorization",
				type: "apiKey",
...
export const updateGroupInfoGroupGroupIdPatch = <ThrowOnError extends boolean = false>(
	...
	return (options.client ?? _heyApiClient).patch<unknown, UpdateGroupInfoGroupGroupIdPatchError, ThrowOnError>({
		security: [
			{
				name: "Authorization",
				type: "apiKey",
