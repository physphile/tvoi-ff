...
export const createGroupRequestGroupPostQueryKey = (options?: Options<CreateGroupRequestGroupPostData>) =>
	createQueryKey("createGroupRequestGroupPost", options);

export const createGroupRequestGroupPostOptions = (options?: Options<CreateGroupRequestGroupPostData>) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const createGroupRequestGroupPostMutation = (options?: Partial<Options<CreateGroupRequestGroupPostData>>) => {
...
export const githubWebhookGithubPostMutation = (options?: Partial<Options<GithubWebhookGithubPostData>>) => {
	const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<GithubWebhookGithubPostData>> = {
		mutationFn: async localOptions => {
			const { data } = await githubWebhookGithubPost({
				...options,
				...localOptions,
...
export const telegramWebhookTelegramPostQueryKey = (options?: Options<TelegramWebhookTelegramPostData>) =>
	createQueryKey("telegramWebhookTelegramPost", options);

export const telegramWebhookTelegramPostOptions = (options?: Options<TelegramWebhookTelegramPostData>) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const telegramWebhookTelegramPostMutation = (options?: Partial<Options<TelegramWebhookTelegramPostData>>) => {
	const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<TelegramWebhookTelegramPostData>> = {
		mutationFn: async localOptions => {
			const { data } = await telegramWebhookTelegramPost({
				...options,
				...localOptions,
...
export const vkWebhookVkPostMutation = (options?: Partial<Options<VkWebhookVkPostData>>) => {
	const mutationOptions: UseMutationOptions<VkWebhookVkPostResponse, DefaultError, Options<VkWebhookVkPostData>> = {
		mutationFn: async localOptions => {
			const { data } = await vkWebhookVkPost({
				...options,
				...localOptions,
...
export const discordWebhookDiscordPostQueryKey = (options?: Options<DiscordWebhookDiscordPostData>) =>
	createQueryKey("discordWebhookDiscordPost", options);

export const discordWebhookDiscordPostOptions = (options?: Options<DiscordWebhookDiscordPostData>) => {
	return queryOptions({
		queryFn: async ({ queryKey, signal }) => {
...
export const discordWebhookDiscordPostMutation = (options?: Partial<Options<DiscordWebhookDiscordPostData>>) => {
	const mutationOptions: UseMutationOptions<unknown, DefaultError, Options<DiscordWebhookDiscordPostData>> = {
		mutationFn: async localOptions => {
			const { data } = await discordWebhookDiscordPost({
				...options,
				...localOptions,
